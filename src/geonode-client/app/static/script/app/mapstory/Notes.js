...
mapstory.plugins.NotesManager = Ext.extend(gxp.plugins.Tool, {
    ...
    saveMsg: 'In order to add annotations, please save your map first by clicking the "Save Map" <div class="x-btn"><div class="ms-icon-save msgbox-button"></div></div> button.',
    isNewMap: null,
    outputAction: 0,
